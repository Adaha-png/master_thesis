...
\begin{figure}[hbtp]
    \centering
    \fbox{\includegraphics[scale=0.3]{images/simple_spread_v3_unstacked/001.png}}
...
\begin{figure}[hbtp]
    \centering
    \fbox{\includegraphics[scale=0.3]{images/knights_archers_zombies_v10_unstacked/015.png}}
...
\begin{figure}[hbtp]
    \centering
    \import{images/simple_spread_v3_unstacked/no_memory/agent}{crit_models_losses_plot_keep2.pgf}
...
\begin{figure}[hbtp]
    \centering
    \import{images/simple_spread_v3_unstacked/no_memory/agent}{pred_models_losses_plot_keep2.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/simple_spread_v3_unstacked/no_memory/agent}{None_none_none_shap_keep2.pgf}
...
\begin{figure}[hbtp]
    \centering
\import{images/simple_spread_v3_unstacked/no_memory/agent}{None_none_ig_shap_keep2.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/simple_spread_v3_unstacked/no_memory/agent}{None_none_ig_slice_shap_keep2.pgf}
...
\begin{figure}[hbtp]
    \centering
\import{images/simple_spread_v3_unstacked/no_memory/agent}{None_one-hot_ig_shap_keep2.pgf}
...
\begin{figure}[hbtp]
    \centering
\import{images/simple_spread_v3_unstacked/no_memory/agent}{None_one-hot_ig_slice_shap_keep2.pgf}
...
\begin{figure}[hbtp]
    \centering
\import{images/simple_spread_v3_unstacked/no_memory/agent}{0_none_none_shap_keep2.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/simple_spread_v3_unstacked/no_memory/agent}{0_one-hot_none_shap.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/simple_spread_v3_unstacked/no_memory/agent}{0_none_shap_shap.pgf}
\caption{Shapley values for state prediction in the simple spread environment for position along the $x$-axis, with included action encoded as one-hot. LM = Landmark, Vel = Velocity, Pos = Position.}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/knight_keep}{crit_models_losses_plot.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/knight_keep}{None_none_none_shap.pgf}
\caption{Shapley values for state prediction in the simple spread environment for position along the $x$-axis, with included action encoded as one-hot. LM = Landmark, Vel = Velocity, Pos = Position.}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/knight_keep}{None_none_ig_shap.pgf}
\caption{Shapley values for state prediction in the simple spread environment for position along the $x$-axis, with included action encoded as one-hot. LM = Landmark, Vel = Velocity, Pos = Position.}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/knight_keep}{None_none_ig_slice_shap.pgf}
\caption{Shapley values for state prediction in the simple spread environment for position along the $x$-axis, with included action encoded as one-hot. LM = Landmark, Vel = Velocity, Pos = Position.}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/knight_keep}{pred_models_losses_plot.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/archer_keep}{crit_models_losses_plot.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/archer_keep}{None_none_ig_shap.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/archer_keep}{None_none_ig_slice_shap.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/archer_keep}{pred_models_losses_plot.pgf}
\caption{Plot for loss measure on state prediction during training of 9 different neural networks, translucent colour is confidence interval}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/archer_keep}{0_none_ig_shap.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/archer_keep}{0_none_ig_slice_shap.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/archer_keep}{1_none_ig_shap.pgf}
...
\begin{figure}[hbtp]
\centering
\import{images/knights_archers_zombies_v10_unstacked/no_memory/archer_keep}{1_none_ig_slice_shap.pgf}
...
\begin{figure}[hbtp]
    \centering
    \import{images/simple_spread_v3/lstm/agent}{pred_models_losses_plot.pgf}
    \caption{Loss on evaluation set for state prediction in the Simple Spread environment}
...
\begin{figure}[hbtp]
    \centering
    \import{images/simple_spread_v3/lstm/agent}{0_none_none_shap.pgf}
    \caption{Plot of losses during training of the event prediction networks on the Simple Spread environment, without softmaxing policy outputs.}
...
\begin{figure}[hbtp]
    \centering
    \import{images/simple_spread_v3/lstm/agent}{1_none_none_shap.pgf}
    \caption{Plot of losses during training of the event prediction networks on the Simple Spread environment, without softmaxing policy outputs.}
...
\begin{figure}[hbtp]
    \centering
    \import{images/simple_spread_v3/lstm/agent}{crit_models_losses_plot.pgf}
...
\begin{figure}[hbtp]
    \centering
    \import{images/simple_spread_v3/lstm/agent}{None_none_none_shap.pgf}
    \caption{Plot of losses during training of the event prediction networks on the Simple Spread environment, without softmaxing policy outputs.}
...
\begin{figure}[hbtp]
    \centering
    \import{images/simple_spread_v3/lstm/agent}{None_none_ig_shap.pgf}
    \caption{Plot of losses during training of the event prediction networks on the Simple Spread environment, without softmaxing policy outputs.}
...
\multicolumn{3}{l}{\textsuperscript{***}$p<0.001$, 
  ...
  \textsuperscript{*}$p<0.05$}
\end{tabular}
\captionof{table}{Average error for event prediction on the Simple Spread environment with frame stacking}
\end{center}
...
\multicolumn{3}{l}{\textsuperscript{***}$p<0.001$, 
  ...
  \textsuperscript{*}$p<0.05$}
\end{tabular}
\captionof{table}{Average error for state prediction on the Knights Archers Zombies environment for archers with frame stacking}
\end{center}
...
\multicolumn{3}{l}{\textsuperscript{***}$p<0.001$, 
  ...
  \textsuperscript{*}$p<0.05$}
\end{tabular}
\captionof{table}{Average accuracy for event prediction on the Knights Archers Zombies environment for archers with frame stacking}
\end{center}
...
\multicolumn{3}{l}{\textsuperscript{***}$p<0.001$, 
  ...
  \textsuperscript{*}$p<0.05$}
\end{tabular}
\captionof{table}{Average error for state prediction on the Knights Archers Zombies environment for knights with frame stacking}
\end{center}
...
\multicolumn{3}{l}{\textsuperscript{***}$p<0.001$, 
  ...
  \textsuperscript{*}$p<0.05$}
\end{tabular}
\captionof{table}{Average accuracy for event prediction on the Knights Archers Zombies environment for knights with frame stacking}
\end{center}
...
\begin{figure}[hbtp]
    \centering
    \import{images/simple_spread_v3_unstacked/no_memory/agent}{crit_models_losses_plot_keep.pgf}
    \caption{Plot of losses during training of the event prediction networks on the Simple Spread environment, without softmaxing policy outputs.}
...
\begin{figure}[hbtp]
    \centering
    \import{images/knights_archers_zombies_v10/no_memory/archer}{1_one-hot_ig_shap.pgf}
    \caption{Plot of losses during training of the event prediction networks on the Simple Spread environment, without softmaxing policy outputs.}
...
\begin{figure}[hbtp]
    \centering
    \import{images/knights_archers_zombies_v10/no_memory/archer}{1_one-hot_none_shap.pgf}
    \caption{Plot of losses during training of the event prediction networks on the Simple Spread environment, without softmaxing policy outputs.}
...
\begin{figure}[hbtp]
    \centering
    \import{images/knights_archers_zombies_v10/no_memory/knight}{1_none_ig_shap.pgf}
