...
from rllib_train import run_inference, train
...
def tuner(trial, max_timesteps=500_000, **env_kwargs):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-t", "--timesteps", type=int, help="Max timesteps", default=8_000
    )
    ...
    optim(tuner, args.n_trials, args.n_jobs, env_fn, **env_kwargs)
